...
/* harmony import */ var _set_style_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(12);
...
function setStyle(clPref) {
	...
	`.replace(/\bfile-tree-diagram/g, clPref);

	const styleClassName = `${clPref}__style`;
